     ...
     # Install Yarn (required for building VS Code)
     ...
     # Get the latest VS Code version
     ...
     # Configure to use Microsoft marketplace
     ...
     # Set product.json to use official marketplace
